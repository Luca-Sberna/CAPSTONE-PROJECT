...
import Ranking from "../GlobalRanking/Ranking";
...
const HomeContent = () => {
  ...
  return (
    <Container fluid className=" pt-5  px-1 position-relative">
      ...
      <Row data-aos="flip-down" className="d-none d-md-flex pb-2">
        <Col md={"3"}></Col>
      ...
      <Row className="game-container-size pb-5">
        <Col
          ...
          md={"3"}
          className="pb-5 pb-md-0 position-relative"
        >
          <Image
        ...
        <Col
          data-aos="flip-down"
          className="ms-3 pb-md-0 d-md-none hero-container h-50 bg-elements rounded-1 text-link position-relative px-0"
        >
          <Image
        ...
        <Col
          ...
          className="d-none d-xxl-flex   rounded-1 p-2 py-3 text-link me-3  position-relative h-50"
        >
          <Image
